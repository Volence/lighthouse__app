...
const lighthouseDataNormalizer_1 = __importDefault(require("../utils/lighthouseDataNormalizer"));
const consoleErrorController = require('../controllers/consoleErrorController');
const moment = require('moment');
const runAudits = async (newSite = null) => {
    if (newSite !== null) {
        try {
...
const formatAuditResults = (formattedResults, fullResults) => {
    ...
    return lighthouseDataNormalizer_1.default(results);
};
